...
set title 'variacion m respecto a S'
...
set output 'test.ps'
# Gráfica  con líneas
plot 'test.plot' title 'function' with lines
...
#plot 2.555555555555555 title 'valor teorico', 'test.plot' title 'estimación' with errorbars, 'prueba.plot' notitle with lines
